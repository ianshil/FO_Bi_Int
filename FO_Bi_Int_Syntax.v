...
(* Is it fine to have these assumptions? *)
...
- clear s. intros. destruct y. right. intro. inversion H. pose (eq_dec_funcs F f).
  destruct s. subst. pose (eq_dec_preserved_vector term (ar_syms f) v IH).
  destruct (s t). subst. auto. right. intro. inversion H. apply n. admit.
